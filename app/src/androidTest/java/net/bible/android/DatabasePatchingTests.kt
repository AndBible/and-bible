...
class DatabasePatchingTests {
    ...
    fun testBookmarkToLabelUpdates() {
        ...
        val bookmark1 = BookmarkEntities.BookmarkWithNotes()
        val bookmark2 = BookmarkEntities.BookmarkWithNotes()
        val bl1 = BookmarkEntities.BookmarkToLabel(bookmark1.bookmarkEntity, label1)
        ...
        val patchFile1 = DatabaseSync.createPatchForDatabase(dbDef1)!!
        DatabaseSync.applyPatchesForDatabase(dbDef2, patchFile1)
        val bl2 = BookmarkEntities.BookmarkToLabel(bookmark2.bookmarkEntity, label1)
    ...
    fun testThreeDevices() {
        ...
        val bookmark1 = BookmarkEntities.BookmarkWithNotes()
        val bookmark2 = BookmarkEntities.BookmarkWithNotes()
        val bookmark3 = BookmarkEntities.BookmarkWithNotes()
        dbDef1.localDb.bookmarkDao().insert(bookmark1.bookmarkEntity)
        dbDef2.localDb.bookmarkDao().insert(bookmark2.bookmarkEntity)
