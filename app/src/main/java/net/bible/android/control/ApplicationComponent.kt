...
interface ApplicationComponent {
    ...
    fun documentBibleBooksFactory(): DocumentBibleBooksFactory
    ...
    fun sortActionBarButton(): SortActionBarButton
    fun speakActionBarButton(): SpeakActionBarButton
    fun speakStopActionBarButton(): SpeakStopActionBarButton
    fun scriptureToggleActionBarButton(): ScriptureToggleActionBarButton
