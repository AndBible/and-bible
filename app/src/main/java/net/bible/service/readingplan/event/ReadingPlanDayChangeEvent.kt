...
package net.bible.service.readingplan.event
...
data class ReadingPlanDayChangeEvent(val readingPlanOneDay: ReadingPlanOneDayDB?, val readingPlanInfo: ReadingPlanInformationDB? = null)
