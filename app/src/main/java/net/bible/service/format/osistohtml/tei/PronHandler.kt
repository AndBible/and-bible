 ...
 */
class PronHandler(parameters: OsisToHtmlParameters, writer: HtmlTextWriter) : HiHandler(parameters, writer) {
    override val tagName = TEIUtil.TEI_ELEMENT_PRON
    ...
    companion object {
        private const val DEFAULT = "italic"
    }
}
