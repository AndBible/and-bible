...
class ReadingPlanDbOperations {
    companion object {
        val instance get() = ReadingPlanDbOperations()
    }

    private val TAG = "ReadingPlanDatabaseOps"
    private val readingPlan = ReadingPlanDatabaseDefinition.ReadingPlan
    private val readingPlanDays = ReadingPlanDatabaseDefinition.ReadingPlanDays
        ...
        get() {
            ...
            if (internalPlans != null) {
                ...
                if (internalProperties != null) {
                    allPlanProperties.addAll(internalProperties)
                }
            }
            ...
            if (userPlans != null) {
                ...
                if (userProperties != null) {
                    allPlanProperties.addAll(userProperties)
                }
            }
