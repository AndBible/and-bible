...
public class BookmarkDatabaseDefinition {
    ...
    public void upgradeToVersion6(SQLiteDatabase db) {
        Log.i(TAG, "Upgrading Bookmark db to version 6");
        db.execSQL("ALTER TABLE " + Table.BOOKMARK + " ADD COLUMN " + BookmarkColumn.BOOK_USED + " TEXT;");
    }
