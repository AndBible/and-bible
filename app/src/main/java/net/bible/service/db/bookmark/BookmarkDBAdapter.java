...
public class BookmarkDBAdapter {
	...
	private interface BookmarkQuery {
        ...
        String[] COLUMNS = new String[] {BookmarkColumn._ID, BookmarkColumn.KEY, BookmarkColumn.VERSIFICATION, BookmarkColumn.CREATED_ON, BookmarkColumn.PLAYBACK_SETTINGS, BookmarkColumn.BOOK_USED};
