...
open class OsisToBibleSpeakTests : AbstractSpeakTests() {
    ...
    fun testTitleFinRK() {
        val cmds = SpeakCommandArray()
        cmds.addAll(SwordContentFacade.getBibleSpeakCommands(s, book, getVerse("Rom.1.1")))
        cmds.addAll(SwordContentFacade.getBibleSpeakCommands(s, book, getVerse("Rom.1.2")))
    ...
    fun testFootnoteFinRK() {
        ...
        cmds.addAll(SwordContentFacade.getBibleSpeakCommands(s, book, getVerse("Gen.1.1")))
        assertThat("Command is of correct type", cmds[0] is PreTitleCommand)
        assertThat("Command is of correct type", cmds[1] is TextCommand)
        assertThat("Command is of correct type", cmds[2] is SilenceCommand)
    ...
    fun testTitle2STLK() {
        ...
        val cmds = SpeakCommandArray()
        cmds.addAll(SwordContentFacade.getBibleSpeakCommands(s, book, getVerse("Jer.11.1")))
        assertThat("Command is of correct type", cmds[0] is PreTitleCommand)
        assertThat("Command is of correct type", cmds[1] is TextCommand)
    ...
    fun testParagraphChangeRK() {
        val cmds = SpeakCommandArray()
        cmds.addAll(SwordContentFacade.getBibleSpeakCommands(s, book, getVerse("Rom.1.23")))
        cmds.addAll(SwordContentFacade.getBibleSpeakCommands(s, book, getVerse("Rom.1.24")))
    ...
    fun testParagraphChangeSTLK() {
        book = Books.installed().getBook("FinSTLK2017") as SwordBook
        val cmds = SpeakCommandArray()
        cmds.addAll(SwordContentFacade.getBibleSpeakCommands(s, book, getVerse("Rom.1.25")))
        cmds.addAll(SwordContentFacade.getBibleSpeakCommands(s, book, getVerse("Rom.1.26")))
        assertThat("Command is of correct type", cmds[0] is TextCommand)
        assertThat("Command is of correct type", cmds[1] is ParagraphChangeCommand)
        assertThat("Command is of correct type", cmds[2] is TextCommand)
        assertThat(cmds.size, equalTo(3))
    ...
    fun testDivinenameInTitle() {
        ...
        book = Books.installed().getBook("FinSTLK2017") as SwordBook
        val cmds = SpeakCommandArray()
        cmds.addAll(SwordContentFacade.getBibleSpeakCommands(s, book, getVerse("Exod.19.1")))
        assertThat("Command is of correct type", cmds[0] is PreTitleCommand)
        assertThat("Command is of correct type", cmds[1] is TextCommand)
...
class SpeakVoiceCustomizationTests {
    ...
    fun testDefaultVoiceSettingValue() {
        ...
        // The new enum should default to SYSTEM_DEFAULT for new behavior
        assertThat(defaultSettings.playbackSettings.voiceSelectionMode, equalTo(net.bible.android.database.bookmarks.VoiceSelectionMode.SYSTEM_DEFAULT))
    }
    ...
    fun testVoiceSelectionModeSerializationSystemDefault() {
        val settings = SpeakSettings(playbackSettings = PlaybackSettings(
            voiceSelectionMode = net.bible.android.database.bookmarks.VoiceSelectionMode.SYSTEM_DEFAULT,
            selectedVoiceName = null
        ))
        val json = settings.toJson()
        val restored = SpeakSettings.fromJson(json)
        assertThat(restored.playbackSettings.voiceSelectionMode, equalTo(net.bible.android.database.bookmarks.VoiceSelectionMode.SYSTEM_DEFAULT))
    ...
    fun testVoiceSelectionModeSerializationLanguageSpecific() {
        val settings = SpeakSettings(playbackSettings = PlaybackSettings(
            voiceSelectionMode = net.bible.android.database.bookmarks.VoiceSelectionMode.LANGUAGE_SPECIFIC,
            selectedVoiceName = null
        ))
        val json = settings.toJson()
        val restored = SpeakSettings.fromJson(json)
        assertThat(restored.playbackSettings.voiceSelectionMode, equalTo(net.bible.android.database.bookmarks.VoiceSelectionMode.LANGUAGE_SPECIFIC))
        assertThat(restored.playbackSettings.selectedVoiceName, equalTo(null))
    }
    ...
    fun testVoiceSelectionModeSerializationManualSelection() {
        val settings = SpeakSettings(playbackSettings = PlaybackSettings(
            voiceSelectionMode = net.bible.android.database.bookmarks.VoiceSelectionMode.MANUAL_SELECTION,
            selectedVoiceName = "com.google.android.tts:en-US-Standard-B"
        ))
        val json = settings.toJson()
        val restored = SpeakSettings.fromJson(json)
        assertThat(restored.playbackSettings.voiceSelectionMode, equalTo(net.bible.android.database.bookmarks.VoiceSelectionMode.MANUAL_SELECTION))
