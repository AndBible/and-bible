...
import {OsisDocument, MyDocumentPageEditInfo} from "@/types/documents";
...
async function startEditing() {
    const info: MyDocumentPageEditInfo = await android.getMyDocumentPageRawContent(bookInitials, osisRef);
    if (!info) return;
