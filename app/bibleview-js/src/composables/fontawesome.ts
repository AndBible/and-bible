...
export function useFontAwesome() {
    ...
    const customExplore: IconDefinition = {
        prefix: 'fas',
        // @ts-ignore
        iconName: 'custom-explore',
        icon: [100, 100, [], "", "M 50 0 C 22.4 0 0 22.4 0 50 C 0 77.6 22.4 100 50 100 C 77.6 100 100 77.6 100 50 C 100 22.4 77.6 0 50 0 Z M 61 61 L 20 80 L 39 39 L 80 20 Z M 50 55.5 c 3 0 5.5 -2.5 5.5 -5.5 c 0 -3 -2.4 -5.5 -5.5 -5.5 c -3 0 -5.5 2.5 -5.5 5.5 c 0 3 2.5 5.5 5.5 5.5 z"]
    }
