...
export function useFontAwesome() {
    ...
    const customMaximiseWindow = {
        prefix: 'fas',
        iconName: 'custom-maximise-window',
        icon: [100, 100, [], null, "M12.6-0.5C5.5-0.5-0.2 5.3-0.2 12.3v74.9c0 7 5.8 12.8 12.8 12.8h74.9c7 0 12.5-5.8 12.5-12.8V12.3C100 5.3 94.5-0.5 87.5-0.5Zm0 9h74.9c2.1 0 3.7 1.8 3.7 3.8v74.9c0 2.2-1.6 3.7-3.7 3.7H37.9V68.5c0-3.7-2.9-6.6-6.6-6.6H8.8V12.3c0-2 1.8-3.8 3.8-3.8zm41.5 7.7c-1.5 0-3.3 1-4.1 2.6-0.8 1.7-0.4 3.9 1 5.1l9.2 9.3-17.4 17.6c-1.9 1.9-1.9 4.4 0 6.2 0 0 0 0 0 0 0.8 1.2 2 1.6 3.1 1.6 1 0 2.4-0.4 3.2-1.6v0L66.6 39.7 76 48.8v0c0.7 1 2.1 1.4 3.1 1.4 0.6 0 1.2-0.2 1.7-0.4h0.1 0.1c1.4-0.8 2.8-2.5 2.8-4.1v-25c0-2.6-2.2-4.5-4.7-4.5z"]
    };

    library.add(customMaximiseWindow)
