...
import net.bible.android.activity.base.AndBaseActivity;
    ...
    public void showErrorMessage(final String message) {
    	if (currentActivity!=null) {
	    	currentActivity.runOnUiThread(new Runnable() {
				@Override
				public void run() {
					if (currentActivity instanceof AndBaseActivity) {
						((AndBaseActivity)currentActivity).showErrorMsg(message);
					} else {
